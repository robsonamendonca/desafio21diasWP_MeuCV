<?php 
 ...
 $plugin_url = str_replace("/include","",$plugin_url);
?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <?php //css
         wp_enqueue_style('meu-cv',  get_stylesheet_directory_uri() .'/meu-cv.css');
         wp_enqueue_style('meu-googleapis-cc', 'http://fonts.googleapis.com/css?family=Rokkitt:400,700|Lato:400,300');
    ?>
    ...
    <div id="cv" class="instaFade">
        <div class="mainDetails">
            <div id="headshot" class="quickFade">
                <img src="<?php echo $plugin_url;?>meu-cv.jpg" alt="Sua foto" />
            </div>
            ...
            <div id="contactDetails" class="quickFade delayFour">
                <ul>
                    <li>e: <a href="mailto:email@seusite.com" target="_blank">email@seusite.com</a></li>
                    <li>w: <a href="http://www.seusite.com">www.seusite.com</a></li>
                    <li>m: 01234567890</li>
                </ul>
            </div>
            <div class="clear"></div>
